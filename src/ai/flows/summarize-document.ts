...
const SummarizeDocumentInputSchema = z.object({
  ...
  prompt: z.string().describe('Instructions to follow when summarizing the document.'),
});
...
const summarizeDocumentPrompt = ai.definePrompt({
  ...
  prompt: `You are an expert summarizer. Summarize the document provided, following the instructions provided. Use the text and any available images from the document to create the summary.
